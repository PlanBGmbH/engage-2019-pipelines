...
## Create Pipeline
az pipelines create --name engage2019-pipeline --repository DSpirit/engage2019-pipelines --repository-type github --yaml-path azure-pipelines.full.yml --branch master --organization https://dev.azure.com/wendelin --project dsdev --service-connection "849386f3-11ef-4659-ab84-4ec6538434622"
